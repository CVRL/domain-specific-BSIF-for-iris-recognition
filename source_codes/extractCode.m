...
%
% This code calculates binary iris codes given the normalized iris image 
% 'im' and the filter set 'texturefilters'.
%
...
function codeBinary = extractCode(img,texturefilters)
